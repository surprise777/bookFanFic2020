                ...
                <div className={styles.signup_panel}>
                    ...
                    <div className={styles.signup_form}>
                        <form autoComplete="off" className={`${styles.signup_form}`}>
                            ...
                            <Link to={RoutesMap.Home.path} className={styles.no_decor}><Button type='button' className={styles.signup_button} checked={this.state.match} onClick={(e)=>this.handleMatch(e)}>
